...
/******/ 	return __webpack_require__(__webpack_require__.s = "a47O");
/******/ })
/************************************************************************/
/******/ ({
...
// module
exports.push([module.i, ".stylesrc-browser-ui-FlipView-assets--flipView{display:\"inline-block\";position:relative}.stylesrc-browser-ui-FlipView-assets--prev{position:absolute;display:inline-block;width:20px;height:30px;background:#999;line-height:28px;font-size:12px;color:#fff;cursor:pointer;text-align:center;opacity:0}.stylesrc-browser-ui-FlipView-assets--prev:hover{opacity:.8}.stylesrc-browser-ui-FlipView-assets--next{position:absolute;display:inline-block;width:20px;height:30px;line-height:28px;font-size:12px;background:#999;right:0;color:#fff;cursor:pointer;text-align:center;opacity:0}.stylesrc-browser-ui-FlipView-assets--next:hover{opacity:.8}", "", {"version":3,"sources":["C:/disk0/repository/kemao/kemao-node-basis/metro-ui/src/browser/ui/FlipView/assets/style.css"],"names":[],"mappings":"AAAA,+CACI,uBAAwB,AACxB,iBAAmB,CACtB,AAED,2CACI,kBAAmB,AACnB,qBAAsB,AACtB,WAAY,AACZ,YAAa,AACb,gBAAiB,AACjB,iBAAkB,AAClB,eAAgB,AAChB,WAAY,AACZ,eAAgB,AAChB,kBAAmB,AACnB,SAAW,CACd,AAED,iDACI,UAAY,CACf,AAED,2CACI,kBAAmB,AACnB,qBAAsB,AACtB,WAAY,AACZ,YAAa,AACb,iBAAkB,AAClB,eAAgB,AAChB,gBAAiB,AACjB,QAAS,AACT,WAAY,AACZ,eAAgB,AAChB,kBAAmB,AACnB,SAAW,CACd,AAED,iDACI,UAAY,CACf","file":"style.css","sourcesContent":[".flipView {\n    display: \"inline-block\";\n    position: relative;\n}\n\n.prev {\n    position: absolute;\n    display: inline-block;\n    width: 20px;\n    height: 30px;\n    background: #999;\n    line-height: 28px;\n    font-size: 12px;\n    color: #fff;\n    cursor: pointer;\n    text-align: center;\n    opacity: 0;\n}\n\n.prev:hover {\n    opacity: .8;\n}\n\n.next {\n    position: absolute;\n    display: inline-block;\n    width: 20px;\n    height: 30px;\n    line-height: 28px;\n    font-size: 12px;\n    background: #999;\n    right: 0;\n    color: #fff;\n    cursor: pointer;\n    text-align: center;\n    opacity: 0;\n}\n\n.next:hover {\n    opacity: .8;\n}"],"sourceRoot":""}]);

// exports
exports.locals = {
	"flipView": "stylesrc-browser-ui-FlipView-assets--flipView",
	"prev": "stylesrc-browser-ui-FlipView-assets--prev",
	"next": "stylesrc-browser-ui-FlipView-assets--next"
};
...
// load the styles
var content = __webpack_require__("IbO8");
...
(function (VIEW) {
     ...
     * 画廊
     */
    VIEW[VIEW["GALLERY"] = 3] = "GALLERY";
})(VIEW = exports.VIEW || (exports.VIEW = {}));
var FlipView = /** @class */ (function (_super) {
    tslib_1.__extends(FlipView, _super);
    function FlipView() {
        ...
        _this.style = __webpack_require__("V+5A");
        return _this;
    }
    ...
    FlipView.prototype.render = function () {
        ...
        var nextText = ">";
        if (this.props.view === VIEW.UP_DOWN) {
            prevStyle = {
        ...
        return React.createElement("div", { className: this.style.flipView, style: {
                width: this.props.width,
                height: this.props.height
            } },
            React.createElement("a", { className: this.style.prev, style: prevStyle, onClick: function () {
                    var active = _this.state.active;
                    active = active - 1;
                    if (active < 0) {
                        active = _this.props.flipList.length - 1;
                    }
                    _this.setState({ active: active });
                } }, prevText),
            React.createElement("a", { className: this.style.next, style: nextStyle, onClick: function () {
                    var active = _this.state.active;
                    active = active + 1;
                    if (active >= _this.props.flipList.length) {
                        active = 0;
                    }
                    _this.setState({ active: active });
                } }, nextText),
            React.createElement("div", { className: this.style.content }, this.props.flipList[this.state.active]));
    };
    return FlipView;
}(React.Component));
...
var FlipView_1 = __webpack_require__("YZdx");
{
    var style = {
        width: 350,
        height: 150,
    ...
    ReactHelper_1.reactHelper.renderElement(
    // <Window
    //     title="FlipView"
    //     width={600}
    //     height={600}
    ...
    React.createElement("div", null,
        React.createElement(FlipView_1.FlipView, { width: 350, height: 150, flipList: [
                React.createElement("div", { style: style }, "1"),
                React.createElement("div", { style: style }, "2"),
                React.createElement("div", { style: style }, "3"),
            ], view: FlipView_1.VIEW.DEFAULT }),
        React.createElement("br", null),
        React.createElement(FlipView_1.FlipView, { width: 350, height: 150, flipList: [
                React.createElement("div", { style: style }, "1"),
                React.createElement("div", { style: style }, "2"),
                React.createElement("div", { style: style }, "3"),
            ], view: FlipView_1.VIEW.UP_DOWN })));
}
...
/******/ });
//# sourceMappingURL=FlipView.js.map